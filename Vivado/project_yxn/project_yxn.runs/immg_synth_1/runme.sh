...
HD_PWD='F:/VIVADO_Project/project_yxn/project_yxn.runs/immg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log immg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source immg.tcl
