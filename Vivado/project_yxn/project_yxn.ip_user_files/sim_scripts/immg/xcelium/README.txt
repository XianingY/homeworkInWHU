...
#
# Generated by export_simulation on Fri Apr 26 09:57:00 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './immg.sh' script.
...
./immg.sh -noclean_files

For more information on the script, please type './immg.sh -help'.
